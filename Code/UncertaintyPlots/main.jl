...
function main()
    ...
    v1 = readdlm("Results/Model_ParameterEstimation/ExperimentalMean/v1/OptimalParameters.csv")
    v2 = readdlm("Results/Model_ParameterEstimation/ExperimentalMean/v2/OptimalParameters.csv")
    v3 = readdlm("Results/Model_ParameterEstimation/ExperimentalMean/v3/OptimalParameters.csv")
    v4 = readdlm("Results/Model_ParameterEstimation/ExperimentalMean/v4/OptimalParameters.csv")
    v5 = readdlm("Results/Model_ParameterEstimation/ExperimentalMean/v5/OptimalParameters.csv")
    mean = (v1 .+ v2 .+ v3 .+ v4 .+ v5)./5
    writedlm("MeanOptimalParameters.csv", mean)
    v1 = readdlm("Results/Model_ParameterEstimation/ExperimentalMean/v1/OptimalObjectives.csv")
    v2 = readdlm("Results/Model_ParameterEstimation/ExperimentalMean/v2/OptimalObjectives.csv")
    v3 = readdlm("Results/Model_ParameterEstimation/ExperimentalMean/v3/OptimalObjectives.csv")
    v4 = readdlm("Results/Model_ParameterEstimation/ExperimentalMean/v4/OptimalObjectives.csv")
    v5 = readdlm("Results/Model_ParameterEstimation/ExperimentalMean/v5/OptimalObjectives.csv")
    mean = (v1 .+ v2 .+ v3 .+ v4 .+ v5)./5
    writedlm("MeanOptimalObjectives.csv", mean)
    # Synthetic Data Box Plots
    a1 = readdlm("Results/Model_ParameterEstimation/SyntheticData/OptimalParameters-0.6.csv")
    a2 = readdlm("Results/Model_ParameterEstimation/SyntheticData/OptimalParameters-0.8.csv")
    a3 = readdlm("Results/Model_ParameterEstimation/SyntheticData/OptimalParameters-1.2.csv")
    a4 = readdlm("Results/Model_ParameterEstimation/SyntheticData/OptimalParameters-2.0.csv")
